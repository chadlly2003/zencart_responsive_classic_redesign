...
<?php $add_id = 'opc-add-' . $opc_address_type; ?>

<?php echo zen_draw_checkbox_field(
"add_address[$opc_address_type]",
'1',
false,
'id="' . $add_id . '"' . $parameters
); ?>

<label class="checkboxLabel custom-control-label"
for="<?php echo $add_id; ?>"
title="<?php echo TITLE_ADD_TO_ADDRESS_BOOK; ?>">
<?php echo TEXT_ADD_TO_ADDRESS_BOOK; ?>
</label>
 <!-- eof updated for WCAG  -->
<?php
    }
?>
            </div>
