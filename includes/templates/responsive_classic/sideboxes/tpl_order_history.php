...
<a title="Quick Re-Order" href="' . zen_href_link($_GET['main_page'], zen_get_all_get_params(['action']) . 'action=cust_order&pID=' . $row['id']) . '"><i class="fa-solid fa-cart-arrow-down"></i></a>
</li>
';
