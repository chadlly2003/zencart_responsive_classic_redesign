...
<a href="' . zen_href_link($_GET['main_page'], zen_get_all_get_params(array('action')) . 'action=cust_order&pid=' . $row['id']) . '"><i title="Add to cart" class="fa-solid fa-cart-arrow-down"></i></a>
</li>
';
