...
<a href="' . zen_href_link($_GET['main_page'], zen_get_all_get_params(array('action')) . 'action=cust_order&pid=' . $row['id']) . '"><i class="fa-solid fa-cart-arrow-down"><span style="display:none;">&nbsp;</span></i></a>
</li>
';
