...
/**
 *  * Motto: "Every business should have a  *
 *  * It uses the User-Agent string combined with specific HTTP headers to detect the  *
 * Homepage: http:// * GitHub: https://github.com/serbanghita/ * README: https://github.com/serbanghita/ * CONTRIBUTING: https://github.com/serbanghita/ * KNOWN LIMITATIONS: https://github.com/serbanghita/ * EXAMPLES: https://github.com/serbanghita/ *
 * @license https://github.com/serbanghita/ * @author  Serban Ghita <serbanghita@gmail.com> (since 2012)
 * @author  Nick Ilyin <nick.ilyin@gmail.com>
 * @author: Victor Stanciu <vic.stanciu@gmail.com> (original author)
 *
 * @version 4.8.06 (manually patched for PHP 8.4 implicit-nulls until PR is merged)
 */
...
use Detection\Exception\use Psr\Cache\InvalidArgumentException;
 ...
 * @method bool isFly()
 * @method bool isWiko()
 * @method bool isi * @method bool isSimValley()
 ...
 * @method bool isiPad()
 * @method bool isNexus * @method bool isGoogle * @method bool isSamsung * @method bool isKindle()
 * @method bool isSurface * @method bool isHP * @method bool isAsus * @method bool isBlackBerry * @method bool isHTC * @method bool isMotorola * @method bool isNook * @method bool isAcer * @method bool isToshiba * @method bool isLG * @method bool isFujitsu * @method bool isPrestigio * @method bool isLenovo * @method bool isDell * @method bool isYarvik * @method bool isMedion * @method bool isArnova * @method bool isIntenso * @method bool isIRU * @method bool isMegafon * @method bool isEboda * @method bool isAllView * @method bool isArchos * @method bool isAinol * @method bool isNokiaLumia * @method bool isSony * @method bool isPhilips * @method bool isCube * @method bool isCoby * @method bool isMID * @method bool isMSI * @method bool isSMiT * @method bool isRockChip * @method bool isFly * @method bool isbq * @method bool isHuawei * @method bool isNec * @method bool isPantech * @method bool isBroncho * @method bool isVersus * @method bool isZync * @method bool isPositivo * @method bool isNabi * @method bool isKobo * @method bool isDanew * @method bool isTexet * @method bool isPlaystation * @method bool isTrekstor * @method bool isPyleAudio * @method bool isAdvan * @method bool isDanyTech * @method bool isGalapad * @method bool isMicromax * @method bool isKarbonn * @method bool isAllFine * @method bool isPROSCAN * @method bool isYONES * @method bool isChangJia * @method bool isGU * @method bool isPointOfView * @method bool isOvermax * @method bool isHCL * @method bool isDPS * @method bool isVisture * @method bool isCresta * @method bool isMediatek * @method bool isConcorde * @method bool isGoClever * @method bool isModecom * @method bool isVonino * @method bool isECS * @method bool isStorex * @method bool isVodafone * @method bool isEssentielB * @method bool isRossMoor * @method bool isi * @method bool isTolino * @method bool isAudioSonic * @method bool isAMPE * @method bool isSkk * @method bool isTecno * @method bool isJXD * @method bool isiJoy * @method bool isFX2 * @method bool isXoro * @method bool isViewsonic * @method bool isVerizon * @method bool isOdys * @method bool isCaptiva * @method bool isIconbit * @method bool isTeclast * @method bool isOnda * @method bool isJaytech * @method bool isBlaupunkt * @method bool isDigma * @method bool isEvolio * @method bool isLava * @method bool isAoc * @method bool isMpman * @method bool isCelkon * @method bool isWolder * @method bool isMediacom * @method bool isMi * @method bool isNibiru * @method bool isNexo * @method bool isLeader * @method bool isUbislate * @method bool isPocketBook * @method bool isKocaso * @method bool isHisense * @method bool isHudl()
 * @method bool isTelstra * @method bool isGeneric * @method bool isAndroidOS()
 * @method bool isBlackBerryOS()
 * @method bool isPalmOS()
 * @method bool isSymbianOS()
 * @method bool isWindows * @method bool isWindowsPhoneOS()
 * @method bool isiOS()
...
class {
    ...
    /**
     * CloudFront headers. E.g. CloudFront-Is-Desktop-Viewer, CloudFront-Is-     * @var array
     */
    protected static array $knownCloudFrontHeaders = [
        'HTTP_CLOUDFRONT_IS_        'HTTP_CLOUDFRONT_IS_        'HTTP_CLOUDFRONT_IS_DESKTOP_VIEWER'
    ];
    ...
    /**
     * HTTP headers that trigger the 'is     * @var array
     */
    protected static array $known        'HTTP_ACCEPT'                  => [
            'matches' => [
                // Opera Mini
        ...
        'HTTP_X_        // Seen this on HTC Sensation. SensationXE_Beats_Z715e.
    ...
    protected static array $phoneDevices = [
        ...
        'HTC'           => [
            ...
            'ADR6400L|ADR6425|001HT|Inspire 4G|Android.*\bEVO\b|T-        ],
        'Nexus'         => 'Nexus One|Nexus S|Galaxy.*Nexus|Android.*Nexus.*        // @todo: Is 'Dell Streak' a         'Dell'          => 'Dell[;]? (Streak|Aero|Venue|Venue Pro|Flash|Smoke|Mini 3iX)|XCD28|XCD35|\b001DL\b|\b101DL\b|\bGS01\b',
        'Motorola'      => [
        ...
        'Asus'          => 'Asus.*Galaxy|PadFone.*        'Xiaomi'        => [
        ...
        // http://www.micromaxinfo.com/        // Added because the codes might conflict with Acer         'Micromax'  => 'Micromax.*\b(A210|A92|A88|A72|A111|A110Q|A115|A116|A110|A90S|A26|A51|A35|A54|A25|A27|A89|A68|A65|A57|A90)\b',
        ...
        'i        // Added simvalley         // http://www.simvalley.fr/telephonie---gps-_22_telephonie-        'SimValley' => '\b(SP-80|XT-930|SX-340|XT-930|SX-310|SP-360|SP60|SPT-800|SP-120|SPT-800|SP-140|SPX-5|SPX-8|SP-100|SPX-8|SPX-12)\b',
         // Wolfgang - a brand that is sold by Aldi supermarkets.
         // http://www.wolfgang        'Wolfgang'  => 'AT-B24D|AT-AS50HD|AT-AS40W|AT-AS55HD|AT-AS45q2|AT-B26D|AT-AS50Q',
        'Alcatel'   => 'Alcatel',
        ...
        'INQ'   => 'INQ',
        'OnePlus'   => 'ONEPLUS',
        // @Tapatalk is a         'GenericPhone'  => 'Tapatalk|PDA;|SAGEM|\bmmp\b|pocket|\bpsp\b|symbian|Smartphone|smartfon|treo|up.browser|up.link|vodafone|\bwap\b|nokia|Series40|Series60|S60|SonyEricsson|N900|MAUI.*WAP.*Browser',
    ];

    /**
     * List of      * @var array
     */
    protected static array $        // @todo: check for         'iPad'              => 'iPad|iPad.*        // Removed |^.*Android.*Nexus(?!(?:        // @see #442
        // @todo Merge Nexus        'Nexus        // https://en.wikipedia.org/wiki/Pixel_C
        'Google        'Samsung            'SM-X616B|SM-X610|SM-X516B|SM-X910|SM-X916B|SM-X816B|SM-X810|SM-X710|SM-X716B|SM-X510|SM-P619|SM-T225|SM-T225N|SM-T736B|SM-T505|SM-T733|SM-X205|SM-X210|SM-X216B',
        ...
        'Kindle'            => 'Kindle|Silk.*Accelerated|Android.*\b(KFOT|KFTT|KFJWI|KFJWA|KFOTE|KFSOWI|KFTHWI|KFTHWA|KFAPWI|KFAPWA|WFJWAE|KFSAWA|KFSAWI|KFASWI|KFARWI|KFFOWI|KFGIWI|KFMEWI)\b|Android.*Silk/[0-9.]+ like Chrome/[0-9.]+ (?!        // Only the Surface         // http://msdn.microsoft.com/en-us/library/ie/hh920767(v=vs.85).aspx
        'Surface        // http://shopping1.hp.com/is-bin/INTERSHOP.enfinity/WFS/WW-USSMBPublicStore-Site/en_US/-/USD/ViewStandardCatalog-Browse?CatalogCategoryID=JfIQ7EN5lqMAAAEyDcJUDwMT
        'HP        // Watch out for PadFone, see #132.
        // http://www.asus.com/de/        'Asus            'ME181C|P01Y|PO1MA|P01Z|\bP027\b|\bP024\b|\bP00C\b',
            ...
            '^.*PadFone((?!        ],
        'BlackBerry        'HTC        'Motorola        'Nook        // http://www.acer.ro/ac/ro/RO/content/drivers
        // http://www.packardbell.co.uk/pb/en/GB/content/download (Packard Bell is part of Acer)
        // http://us.acer.com/ac/en/US/content/group/        // http://www.acer.de/ac/de/DE/content/models/        // Can conflict with Micromax and Motorola phones codes.
        'Acer            'Android.*; \b(A100|A101|A110|A200|A210|A211|A500|A501|A510|A511|A700|A701|W500|W500P|W501|W501P|W510|W511|W700|G100|G100W|B1-A71|B1-710|B1-711|A1-810|A1-811|A1-830)\b',
            'W3-810|\bA3-A10\b|\bA3-A11\b|\bA3-A20\b|\bA3-A30|A3-A40'
        ],
        // http://eu.computers.toshiba-europe.com/innovation/family/        // http://us.toshiba.com/        // http://www.toshiba.co.jp/regza/        'Toshiba        // http://www.nttdocomo.co.jp/english/service/developer/smart_phone/technical_info/spec/index.html
        // http://www.lg.com/us/        'LG        'Fujitsu        // Prestigio         'Prestigio            'PMP3170B|PMP3270B|PMP3470B|PMP7170B|PMP3370B|PMP3570C|PMP5870C|PMP3670B|PMP5570C|PMP5770D|PMP3970B|PMP3870C|PMP5580C|PMP5880D|PMP5780D|PMP5588C|PMP7280C',
        ...
        'Lenovo            'TB-X704L|TB-J606F|TB-X606F|TB-X306X|YT-J706X|TB128FU',
            ...
            'Lenovo TAB|Idea(Tab|Pad)( A1|A10| K1|)|ThinkPad([ ]+)?        ],
        // http://www.dell.com/support/home/us/en/04/Products/tab_mob/        'Dell        'Xiaomi        // http://www.yarvik.com/en/matrix/        'Yarvik            'Android.*\b(TAB10-400|TAB10-410|TAB13-201|TAB274EUK|TAB275EUK|TAB374EUK|TAB462EUK|TAB474EUK|TAB9-200)\b',
        ...
        'Medion        'Arnova        // http://www.intenso.de/kategorie_en.php?kategorie=33
        // @todo: http://www.nbhkdz.com/read/b8e64202f92a2df129126bff.html - investigate
        'Intenso        // IRU.ru         'IRU        'Megafon        // http://www.e-boda.ro/        'Eboda        // http://www.allview.ro/produse/droseries/lista-        'AllView        // http://wiki.archosfans.com/index.php?title=Main_Page
        // @note Rewrite the regex format after we add more UAs.
        'Archos        // http://www.ainol.com/plugin.php?identifier=ainol&module=product
        'Ainol        'NokiaLumia        // @todo: inspect http://esupport.sony.com/US/p/select-system.pl?DIRECTOR=DRIVER
        // Readers http://www.atsuhiro-me.net/ebook/sony-reader/sony-reader-web-browser
        // http://www.sony.jp/support/        'Sony            'EBRD1101|EBRD1102|EBRD1201|SGP351|SGP341|SGP511|SGP512|SGP521|SGP541|SGP551|SGP621|SGP641|SGP612|SOT31|SGP771|SGP611|SGP612|SGP712',
            'Sony.*        ],
        // http://www.support.philips.com/support/catalog/worldproducts.jsp?userLanguage=en&userCountry=cn&categoryid=3G_LTE_        'Philips        // db + http://www.cube-        'Cube        // http://www.cobyusa.com/?p=pcat&pcat_id=3001
        'Coby        // http://www.match.net.cn/products.asp
        'MID            'M9701|M9000|M9100|M806|M1052|M806|T703|MID701|MID713|MID710|MID727|MID760|MID830|MID728|MID933|MID125|MID810|MID732|MID120|MID930|MID800',
        ...
        // @todo Research the Windows         'MSI        // @todo http://www.kyocera    //    'Kyocera        // @todo http://intexuae.com/index.php/category/    //    'Intext        // http://pdadb.net/index.php?m=pdalist&list=SMiT (NoName Chinese         // http://www.imp3.net/14/show.php?itemid=20454
        'SMiT        // http://www.rock-chips.com/index.php?do=prod&pid=2
        'RockChip        // http://www.fly-phone.com/devices/        'Fly        // http://www.bqreaders.com/gb/        'bq        // http://www.huaweidevice.com/worldwide/productFamily.do?method=index&directoryId=5011&treeId=3290
        // http://www.huaweidevice.com/worldwide/downloadCenter.do?method=index&directoryId=3372&treeId=0&tb=1&type=software (including legacy         'Huawei        // Nec or Medias Tab
        'Nec        // Pantech         'Pantech        // Broncho         'Broncho        // http://versusuk.com/support.html
        'Versus        // http://www.zync.in/index.php/our-products/        'Zync        // http://www.positivoinformatica.com.br/www/pessoal/        'Positivo        // https://www.nabi        'Nabi        'Kobo        // French Danew         'Danew        // Texet         'Texet            'TB-840HD|TB-760HD|TB-750HD|TB-740HD|TB-730HD|TB-722HD|TB-720HD|TB-700HD|TB-500HD|TB-470HD|TB-431HD|TB-430HD|TB-506|TB-504|TB-446|TB-436|TB-416|TB-146SE|TB-126SE',
        ...
        // Avoid detecting 'PLAYSTATION 3' as         'Playstation        // http://www.trekstor.de/surftabs.html
        'Trekstor        // http://www.pyleaudio.com/Products.aspx?%2fproducts%2fPersonal-Electronics%2f        'PyleAudio        // http://www.advandigital.com/index.php?link=content-product&jns=JP001
        // because of the short codenames we have to include whitespaces to reduce the possible conflicts.
        'Advan        // http://www.danytech.com/category/        'DanyTech        // http://www.galapad.net/product.html ; https://github.com/serbanghita/        'Galapad        // http://www.micromaxinfo.com/        'Micromax        // http://www.karbonn        'Karbonn        // http://www.myallfine.com/Products.asp
        'AllFine        // http://www.proscanvideo.com/products-search.asp?itemClass=        'PROSCAN            '\b(PLT8088|PLT8223G|PLT8234G|PLT8235G|PLT8816K|PLT9011|PLT9045K|PLT9233G|PLT9735|PLT9760G|PLT9770G)\b',
        ...
        'YONES        // http://www.cjshowroom.com/eproducts.aspx?classcode=004001001
        // China manufacturer makes         'ChangJia            'TPC10101|TPC10103|TPC10106|TPC10111|TPC10203|TPC10205|TPC10503',
        ...
        // http://www.allwinnertech.com/en/apply/        // http://www.ptcl.com.pk/pd_content.php?pd_id=284 (EVOTAB)
        // @todo: Softwiner         // aka. Cute or Cool         'GU        // http://www.pointofview-online.com/showroom.php?shop_mode=product_listing&category_id=118
        'PointOfView            'TAB-PL1015|TAB-P1025|TAB-PI1045|TAB-P1325|TAB-PROTAB[0-9]+|TAB-PROTAB25|TAB-PROTAB26|TAB-PROTAB27|TAB-PROTAB26XL|TAB-PROTAB2-IPS9|TAB-PROTAB30-IPS9|TAB-PROTAB25XXL|TAB-PROTAB26-IPS10|TAB-PROTAB30-IPS10',
        ...
        // http://www.overmax.pl/pl/katalog-produktow,p8/        // @todo: add more tests.
        'Overmax        // http://hclme        'HCL        // http://www.edigital.hu/        'DPS        // http://www.visture.com/index.asp
        'Visture        // http://www.mijncresta.nl/        'Cresta        // MediaTek - http://www.mediatek.com/_en/01_products/02_proSys.php?cata_sn=1&cata1_sn=1&cata2_sn=309
        'Mediatek        // Concorde tab
        'Concorde        // GoClever         'GoClever            'TAB T72|TAB R83|TAB R974|TAB R973|TAB A101|TAB A103|TAB A104|TAB A104.2|R105BK|M713G|A972BK|TAB A971|TAB R974.2|TAB R104|TAB R83.3|TAB A1042',
        ...
        // Modecom         'Modecom            'FreeTAB 9000|FreeTAB 7.4|FreeTAB 7004|FreeTAB 7800|FreeTAB 2096|FreeTAB 7.5|FreeTAB 1014|FreeTAB 1001 |FreeTAB 8001|FreeTAB 9706|FreeTAB 9702',
        ...
        // Vonino         'Vonino            '\b(Argus[ _]?S|Diamond[ _]?79HD|Emerald[ _]?78E|Luna[ _]?70C|Onyx[ _]?S|Onyx[ _]?Z|Orin[ _]?HD|Orin[ _]?S|Otis[ _]?S|SpeedStar[ _]?S|Magnet[ _]?M9|Primus[ _]?94[ _]?3G|Primus[ _]?94HD|Primus[ _]?QS)\b',
            '\b(Android.*\bQ8\b|Sirius[ _]?EVO[ _]?QS|Sirius[ _]?QS|Spirit[ _]?S)\b',
        ],
        // ECS         'ECS        // Storex         // @note: no need to add all the         'Storex        // Generic Vodafone         'Vodafone        // French         // Aka: http://www.essentielb.fr/
        'EssentielB        // Ross & Moor - http://ross-moor.ru/
        'RossMoor        // i-        'i        // http://www.tolino.de/de/vergleichen/
        'Tolino        // AudioSonic - a Kmart brand
        ...
        'AudioSonic        // AMPE         // @todo: add them gradually to avoid conflicts.
        'AMPE        // Skk         'Skk        // Tecno         'Tecno        // JXD (consoles &         'JXD            'Android.* \b(F3000|A3300|JXD5000|JXD3000|JXD2000|JXD300B|JXD300|S5800|S7800|S602b|S5110b|S7300|S5300|S602|S603)\b',
        ...
        // i-Joy         'iJoy            '            '            '            '        ],
        // http://www.intracon.eu/        'FX2        // http://www.xoro.de/produkte/
        // @note: Might be the same brand with 'Simply         'Xoro            'KidsPAD 701|PAD[ ]?712|PAD[ ]?714|PAD[ ]?716|PAD[ ]?717|PAD[ ]?718|PAD[ ]?720|PAD[ ]?721|PAD[ ]?722|PAD[ ]?790',
        ...
        // http://www1.viewsonic.com/products/computing/        'Viewsonic        // https://www.verizonwireless.com/        'Verizon        // http://www.odys.de/web/internet-        'Odys        // http://www.captiva-power.de/products.html#        'Captiva        // IconBIT - http://www.iconbit.com/products/        'Iconbit        // http://www.teclast.com/topic.php?channelID=70&topicID=140&pid=63
        'Teclast            'T98 4G|\bP80\b|\bX90HD\b|X98 Air|X98 Air 3G|\bX89\b|P80 3G|\bX80h\b|P98 Air|\bX89HD\b|P98 3G|\bP90HD\b|P89 3G|X98 3G',
        ...
        // Onda - http://www.onda-        'Onda            '\b(V975i|Vi30|VX530|V701|Vi60|V701s|Vi50|V801s|V719|Vx610w|VX610W|V819i|Vi10|VX580W|Vi10|V711s|V813|V811)\b[\s]+',
        ...
        'Jaytech        'Blaupunkt        // http://www.digma.ru/support/download/
        // @todo: Ebooks also (if requested)
        'Digma        // http://www.evolioshop.com/ro/        // http://www.evolio.ro/support/downloads_static.html?cat=2
        // @todo: Research some more
        'Evolio        // @todo http://www.lava        'Lava        // http://www.breeze        'Aoc        // http://www.mpmaneurope.com/en/products/internet-        'Mpman            'MP11 OCTA|MP10 OCTA|MPQC1114|MPQC1004|MPQC994|MPQC974|MPQC973|MPQC804|MPQC784|MPQC780|\bMPG7\b|MPDCG75|MPDCG71',
        ...
        // https://www.celkon        'Celkon        // http://www.wolderelectronics.com/productos/manuales-y-guias-rapidas/categoria-2-miTab
        'Wolder            'miTab \b(DIAMOND|SPACE|BROOKLYN|NEO|FLY|MANHATTAN|FUNK|EVOLUTION|SKY|GOCAR|IRON|GENIUS|POP|MINT)\b',
        ...
        'Mediacom        // http://www.mi.com/en
        'Mi        // http://www.nbru.cn/index.html
        'Nibiru        // http://navroad.com/products/produkty/        // http://navroad.com/products/produkty/        'Nexo        // http://leader-online.com/new_site/product-category/        // http://www.leader-online.net.au/List/        'Leader            'TBLT10Q|TBLT10I|TBL-10WDKB|TBL-10WDKBO2013|TBL-W230V2|TBL-W450|TBL-W500|SV572|TBLT7I|TBA-AC7-8G',
            'TBLT79|TBL-8W16|TBL-10W32|TBL-10WKB|TBL-W100',
        ],
        // http://www.datawind.com/ubislate/
        'Ubislate        // http://www.pocketbook-int.com/ru/support
        'PocketBook        // http://www.kocaso.com/product_        'Kocaso        // http://global.hisense.com/product/asia/        'Hisense        // http://www.tesco.com/direct/hudl/
        'Hudl'              => 'Hudl HT7S3|Hudl 2',
        // http://www.telstra.com.au/home-phone/thub-2/
        'Telstra        'Generic            'Android.*\b97D\b|            '\bM721\b|rk30sdk|\bEVOTAB\b|M758A|ET904|ALUMIUM10|Smartfren Tab|Endeavour 1010|            '\bM6pro\b|CT1020W|arc 10HD|\bTP750\b|\bQTAQZ3\b|WVT101|TM1088|KT107',
        ],
    ];
    ...
    protected static array $operatingSystems = [
        'AndroidOS'         => 'Android',
        'BlackBerryOS'      => 'blackberry|\bBB10\b|rim         'PalmOS'            => 'PalmOS|avantgo|blazer|elaine|hiptop|palm|plucker|xiino',
        'SymbianOS'         => 'Symbian|SymbOS|Series60|Series40|SYB-[0-9]+|\bS60\b',
        // @reference: http://en.wikipedia.org/wiki/Windows_        'Windows        // @reference: http://en.wikipedia.org/wiki/Windows_Phone
        // http://wifeng.cn/?r=blog&a=view&id=106
        // http://nicksnettravels.builttoroam.com/post/2011/01/10/Bogus-Windows-Phone-7-User-Agent-String.aspx
        // http://msdn.microsoft.com/library/ms537503.aspx
        // https://msdn.microsoft.com/en-us/library/hh869301(v=vs.85).aspx
        'WindowsPhoneOS'   => 'Windows Phone 10.0|Windows Phone 8.1|Windows Phone 8.0|Windows Phone OS|XBLWP7|ZuneWP7|Windows NT 6.[23]; ARM;',
        'iOS'               => '\biPhone.*        // https://en.wikipedia.org/wiki/IPadOS
        'iPadOS' => 'CPU OS 13',
    ...
    /**
     * List of      *
     * IMPORTANT: This is a list of      * Since      *      * @var array
     */
    protected static array $browsers = [
        //'Vivaldi'         => 'Vivaldi',
        // @reference: https://developers.google.com/chrome/        'Chrome'          => '\bCrMo\b|CriOS.*        'Dolfin'          => '\bDolfin\b',
        'Opera'           => 'Opera.*Mini|Opera.*Mobi|Android.*Opera|        'Skyfire'         => 'Skyfire',
        // Added "Edge on iOS" https://github.com/serbanghita/        'Edge'             => 'EdgiOS.*        'IE'              => 'IE        'Firefox'         => 'fennec|firefox.*maemo|(        'Bolt'            => 'bolt',
        'TeaShark'        => 'teashark',
        'Blazer'          => 'Blazer',
        // @reference: http://developer.apple.com/library/safari/#documentation/AppleApplications/Reference/SafariWebContent/OptimizingforSafarioniPhone/OptimizingforSafarioniPhone.html#//apple_ref/doc/uid/TP40006517-SW3
        // Excluded "Edge on iOS" https://github.com/serbanghita/        'Safari'          => 'Version((?!\bEdgiOS\b).)*        // http://en.wikipedia.org/wiki/Midori_(web_browser)
        //'Midori'          => 'midori',
        //'Tizen'           => 'Tizen',
        ...
        // https://github.com/serbanghita/        'DiigoBrowser'    => 'DiigoBrowser',
        // http://www.puffinbrowser.com/index.php
        // https://github.com/serbanghita/        // 'Puffin'            => 'Puffin',
        ...
        // http://en.wikipedia.org/wiki/Vision_        'GenericBrowser'  => 'NokiaBrowser|OviBrowser|OneBrowser|TwonkyBeamBrowser|SEMC.*Browser|FlyFlow|Minimo|NetFront|Novarra-Vision|MQQBrowser|MicroMessenger',
        // @reference: https://en.wikipedia.org/wiki/Pale_Moon_(web_browser)
        'PaleMoon'        => 'Android.*PaleMoon|    ];
    ...
    protected static array $knownUserAgentHttpHeaders = [
        ...
        // Vodafone specific header: http://www.seoprinciple.com/        'HTTP_X_DEVICE_USER_AGENT',
    ...
    protected static array $properties = [
        ...
        'Edge' => 'Edge/[VER]',
        'IE'      => ['IE        // http://en.wikipedia.org/wiki/NetFront
    ...
    public function __construct(
        ...
        // to something other than a string, an         if ($this->config['autoInitOfHttpHeaders']) {
    ...
    /**
     * On startup      * HTTP headers extracted from $_SERVER.
     *
     * @return void
     */
    public function autoInitKnownHttpHeaders(): void
    {
        ...
        $knownHttpHeaders = array_merge(
            ...
            array_keys(self::$known            array_values(self::$knownCloudFrontHeaders)
        );
...
//        }, ARRAY_FILTER_USE_KEY);
        ...
        // https://github.com/serbanghita/        if (!$this->hasUserAgent()) {
            $this->setUserAgent("");
        }
    }
    ...
    /**
     * Method gets the      * This method is used for the magic methods $detect->is*().
    ...
    /**
     * Check the HTTP headers for signs of      * This is the fastest      * inside is     *
     * @return bool
     */
    public function checkHttpHeadersFor    {
        foreach ($this->get            if (isset($this->httpHeaders[$                if (isset($matchType['matches']) && is_array($matchType['matches'])) {
                    foreach ($matchType['matches'] as $_match) {
                        if (str_contains($this->httpHeaders[$                            return true;
                        }
                    }
    ...
    /**
     * Check if the device is      * Returns true if any type of      * @return bool
     * @throws      */
    public function is    {
        ...
        // Cache check.
        try {
            $cacheKey = $this->createCacheKey("            $cacheItem = $this->cache->get($cacheKey);
            if (!is_null($cacheItem)) {
                return $cacheItem->get();
            }

            // Special case: Amazon CloudFront             if (
                $this->getUserAgent() === self::$cloudFrontUA &&
                $this->getHttpHeader('HTTP_CLOUDFRONT_IS_            ) {
                $this->cache->set($cacheKey, true);
                return true;
            }

            if ($this->hasHttpHeaders() && $this->checkHttpHeadersFor                $this->cache->set($cacheKey, true);
                return true;
            } else {
    ...
    /**
     * Check if the device is a      * Return true if any type of      * @return bool
     * @throws      */
    public function is    {
        if (!$this->hasUserAgent()) {
            throw new         }
        ...
        try {
            ...
            foreach (static::$                $regexString = $_regex;
