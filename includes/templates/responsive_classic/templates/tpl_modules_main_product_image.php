...
<!-- Modal HTML -->
<div id="imageModalPrimary" class="imgmodal" style="display:none;">
...
<!-- Main Product Image (SEO-Friendly Link) -->
<div id="productMainImage" class="centeredContent back">
    <!-- Use a real link for SEO purposes -->
    <a href="<?php echo zen_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $products_id); ?>" 
       title="<?php echo $products_name; ?>" 
