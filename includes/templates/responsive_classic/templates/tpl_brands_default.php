...
foreach ($brands["featured"] as $record) {
    ...
    $lc_text .=
        ...
        zen_image(
            DIR_WS_IMAGES . $record["manufacturers_image"],
            $record["manufacturers_name"],
            BRANDS_IMAGE_WIDTH,
            BRANDS_IMAGE_HEIGHT
        ) .
        "</div>";
    $lc_text .=
        '<div class="brandName">' . $record["manufacturers_name"] . "</div>";
    $lc_text .= "</a>";
...
<?php }
    ...
    //
    // IMPORTANT:
    // All manufacturers are contained inside ONE brandCell div.
    //
...
<?php foreach ($brands["other"] as $record) {
    $brand_url = zen_href_link(
        FILENAME_DEFAULT,
        "manufacturers_id=" . $record["manufacturers_id"]
    ); ?>
            ...
            <a href="<?php echo $brand_url; ?>">
                ...
                <div class="brandName">
                    <?php echo $record["manufacturers_name"]; ?>
                </div>
