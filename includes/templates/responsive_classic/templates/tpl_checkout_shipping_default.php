...
<div id="checkoutShipto" class="floatingBox changeaddress">
<?php if ($displayAddressEdit) { ?>
<div class="buttonRow changeaddress"><?php echo '<a href="' . $editShippingButtonLink . '">' . zen_image_button(BUTTON_IMAGE_CHANGE_ADDRESS, BUTTON_CHANGE_ADDRESS_ALT) . '</a>'; ?></div>
<?php } ?>
<address class=""><?php echo zen_address_label($_SESSION['customer_id'], $_SESSION['sendto'], true, ' ', '<br>'); ?></address>
</div>
<div class="floatingBox notice"><?php echo TEXT_CHOOSE_SHIPPING_DESTINATION; ?></div>
...
<div id="checkoutShippingContentChoose" class="notice_select"><?php echo TEXT_CHOOSE_SHIPPING_METHOD; ?></div>
